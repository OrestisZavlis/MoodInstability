...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%%%%%%%%%%%%%%%%%%%% SIMULATION 2 EMOTIONAL RIGIDITY %%%%%%%%%%%%%%%%%%%%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
% 2. Bipolar     evaluation  (μ=60, π=1/20, α=0.001)
% 3. Depressive  evaluation  (μ>60, π=1/20, α=0.001)
% 4. (Hypo)Manic evaluation  (μ<60, π=1/20, α=0.001)
...
title(['(C) Bipolar Rigidity (μ{_0}=60, π=0.05, α=0.001)'], ...             % Plot bipolar affective title
       'FontSize', 10.8)                                                    % Adjust font size
ylabel ('V(R)', 'FontSize', 10)                                             % Plot y axis only
ax = gca;                                                                   % Get current axes handle
ax.YTick = 0:0.2:1;                                                         % Set y-axis ticks at intervals of 20
...
title({['(D) Depressive Rigidity (μ{_0}=100, π=0.05, α=0.001) & ' ...       % Plot depressive affective title
        '(E) Manic Rigidity (μ{_0}=20, π=0.05, α=0.001)']}, ...             % Plot manic affective title
        'FontSize', 10.8)                                                   % Adjust font size
...
% --------------------------- PRINT FIGURE 2 --------------------------- % 
% ---------------------------------------------------------------------- % 
printfigure(10, 10, 'Figure 2.pdf')                                         % See function printfigure
