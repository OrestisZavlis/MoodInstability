...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%%%%%%%%%%%%%%%%%%% SIMULATION 4 EMOTIONAL REACTIVITY %%%%%%%%%%%%%%%%%%%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
...
% 2. Reactive             evaluation  (μ=60, π>1/20, α=0.2)
% 3. Reactive  & Bipolar  evaluation  (μ=60, π>1/20, α=0.001)
...
title(['(C) Emotional Reactivity (μ{_0}=60, π=0.1, α=0.2)'], ...            % Plot reactive affective title
       'FontSize', 10.8)                                                    % Adjust font size
ylabel ('V(R)', 'FontSize', 10)                                             % Plot y axis only
ax = gca;                                                                   % Get current axes handle
ax.YTick = 0:0.2:1;                                                         % Set y-axis ticks at intervals of 20
...
title(['(D) Emotional Reactivity & ' ...                                    % Plot reactive affective title
...
% --------------------------- PRINT FIGURE 4 --------------------------- % 
% ---------------------------------------------------------------------- % 
printfigure(10, 10, 'Figure 4.pdf')                                         % See function printfigure
