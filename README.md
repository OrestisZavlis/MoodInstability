...
In the second to fourth simulations, I show how this model could generate three well-known longitudinal types of mood instability: namely, emotional rigidity (see MATLAB file: Simulation_2_Dynamic_Evaluation_Rigidity.m), emotional transience (see MATLAB file: Simulation_3_Dynamic_Evaluation_Transience.m), and emotional reactivity (see MATLAB file: Simulation_4_Dynamic_Evaluation_Reactivity.m). Briefly explained here as well, rigidity refers to the tendency to experience prolonged emotions (like persistent depression or mania) due to an extremely low learning rate; transiency refers to the tendency to experience fleeting emotions (as seen in borderline instability) due to an extremely high learning rate; finally, reactivity refers to the tendency to experience strong emotions (like reactive emotions, as seen in various temperamental disorders). These patterns are explored either in combination or in isolation and are fully depicted in the final simulation file (see MATLAB file: Simulation_5_Dynamic_Evaluation_Everything.m). 


## Conclusion
Together, the simulations above have at least three important implications for our theoretical understanding of mood instability. First, they suggest that mood instability can be distiled into three emotional types: rigidity, transience, and reactivity. Second, they suggest that specific parameters of the dynamic model can generate specific mood instabilities, explaining their computational origins: to briefly elaborate, a low learning rate can generate persisting emotions (implying that emotional rigidity may be explained by an inability to update expectations of rewards), a high learning rate can generate fleeting emotions (implying that emotional transience may be explained by the tedency to over-identity with recent realities being overly disappointed or overly elated whenever they change), and a high weight parameter can generate strong emotions (implying that emotional reactivity may be explained by the tendency to over-weigh the meaning of prediction errors). Finally, the simulations above generate specific predictions ... 
