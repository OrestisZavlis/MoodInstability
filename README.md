...
In the first MATLAB file (Static_Evaluation.m), I show that when we alter the two main parameters of this model (namely, reference point and uncertainty), we can reproduce different emotional problems (namely, depression / mania and apathy / reactivity, respectively). I turn to the instability of these problems in the next section that details dynamic evaluation. 
